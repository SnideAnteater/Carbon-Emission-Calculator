    ...
    <table class="min-w-full text-left text-sm">
      ...
      <tbody class="divide-y divide-gray-200">
        ...
        <tr>
          ...
          <!-- Petrol -->
          <td class="px-4 py-2">
            {{ Math.round(sumLPGkgco2 * 1000) / 1000 }}
          </td>
          <td class="px-4 py-2">
            {{ Math.round(sumLPGkgCH4 * 1000) / 1000 }}
          </td>
          <td class="px-4 py-2">
            {{ Math.round(sumLPGkgN2O * 1000) / 1000 }}
          </td>
          <td class="px-4 py-2">
            {{ Math.round(sumLPGkgCO2eq * 1000) / 1000 }}
          </td>
        </tr>
      </tbody>
    </table>
    ...
    <table class="min-w-full text-left text-sm">
      ...
      <tbody class="divide-y divide-gray-200">
        ...
        <tr>
          ...
          <!-- Petrol -->
          <td class="px-4 py-2">
            {{ Math.round(sumNGkgco2 * 1000) / 1000 }}
          </td>
          <td class="px-4 py-2">
            {{ Math.round(sumNGkgCH4 * 1000) / 1000 }}
          </td>
          <td class="px-4 py-2">
            {{ Math.round(sumNGkgN2O * 1000) / 1000 }}
          </td>
          <td class="px-4 py-2">
            {{ Math.round(sumNGkgCO2eq * 1000) / 1000 }}
          </td>
        </tr>
      </tbody>
    </table>
